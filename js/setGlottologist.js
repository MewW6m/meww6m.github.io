...
function glotassigns(glot){ // setLanguageText
    ...
    glot.assign('psy', { ja: '１プロジェクト目', en: 'First project'});
    glot.assign('psy1', { ja: '配送業者向け管理システム新規開発', en: 'Delivery company system System development'});
    glot.assign('psy2', { ja: '配送業者向け管理システムを新規で1から開発した', en: 'Developed a new management system for delivery companies from scratch'});
    glot.assign('psys', { ja: '２プロジェクト目', en: 'Second project'});
    glot.assign('psys1', { ja: '配送業者向け管理システム改修', en: 'Repair of management system for delivery companies'});
    glot.assign('psys2', { ja: '配送業者向け管理システムの改修(2回)', en: 'Repair of management system for delivery companies (two times)'});
    glot.assign('voi', { ja: '３プロジェクト目', en: 'Third project'});
    glot.assign('voi1', { ja: '工事現場向け点呼システムの新規構築', en: 'New construction of roll call system for construction sites'});
